...
namespace EmployeeDirectoryManager
{
    internal class MainForm : Form //Makes our class extend the Form class
    {
        ...
        public MainForm()
        {
            ...
            //Row 1 Labels
            txtId.Anchor = txtName.Anchor = txtDepartment.Anchor = txtRole.Anchor = txtSalary.Anchor = dtHire.Anchor = 
            ...
            btnAdd.Height = btnUpdate.Height = btnDelete.Height = btnSave.Height = btnLoad.Height = btnExit.Height = 40;
            ...
            grid.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = nameof(Employee.FullName), HeaderText = "Full Name", 
            AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill});
            grid.Columns.Add(new DataGridViewTextBoxColumn { DataPropertyName = nameof(Employee.Department), HeaderText = "Department", Width = 120 });
        ...
        private (string id, string name, string department, string role, double salary, DateTime hire) ReadInputs()
        {
            ...
            if (salary < 0) throw new Exception("Salary must be postitve.");
            if (hire > DateTime.Today) throw new Exception("Hire date cannot be in the future.");
